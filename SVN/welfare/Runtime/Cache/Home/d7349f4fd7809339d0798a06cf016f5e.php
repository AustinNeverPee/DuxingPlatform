...
<html lang="zh-cn">
  <head>
    ...
    <link href="<?php echo ($static); ?>/css/activity_display.css" rel="stylesheet" type="text/css" media="screen">
  ...
  <body>
    ...
    <div class="btn-group-vertical levelTwo">
      ...
      <a href="activity_feedback.html" class="btn btn-info" role="button" id="actfeedback">
        查看反馈
      </a>
      <a href="activity_sign_up.html" class="btn btn-info" role="button" id="actattend">
        报名参加
      </a>
    </div><!-- /二级菜单按钮-->
    ...
    <script src="<?php echo ($static); ?>/js/holder.js" type="text/javascript"></script>
    <script src="<?php echo ($static); ?>/js/activity_display.js" type="text/javascript" charset="utf-8"></script>
  </body>
</html>