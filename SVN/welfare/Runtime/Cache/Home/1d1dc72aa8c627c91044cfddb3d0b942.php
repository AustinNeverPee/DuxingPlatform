...
<html lang="zh-cn">
  <head>
    ...
    <link href="css/location_album.css" rel="stylesheet" type="text/css" media="screen">
  ...
  <body>
    ...
    <div class="container holder">
      <div class="jumbotron">
        <div class="row">
          <!--筛选框-->
          <div class="col-md-2 well" id="filter-box"></div>

          <!--主体-->
          <div class="col-md-10" id="main-box">
            <!--各个相册块儿-->
            <div class="text-center well photoBlock">
              <h3>name<small>crattiome</small></h3>
              <div id="box1" class="carousel slide border-set">
                <ol class="carousel-indicators">
                  <li data-target="#box1" data-slide-to = "0" class="active"></li>
                  <li data-target="#box1" data-slide-to = "1"></li>
                  <li data-target="#box1" data-slide-to = "2"></li>
                </ol>
                ...
                <a class="left carousel-control" href="#box1" data-slide="prev">
                  &lsaquo;
                </a>
                <a class="right carousel-control" href="#box1" data-slide="next">
                  &rsaquo;
                </a>
              </div>
            </div>
            <div class="text-center well photoBlock">
              <h3>name<small>crattiome</small></h3>
              <div id="box2" class="carousel slide border-set">
                <ol class="carousel-indicators">
    ...
    <script src="js/location_album.js" type="text/javascript"></script>
  </body>
</html>