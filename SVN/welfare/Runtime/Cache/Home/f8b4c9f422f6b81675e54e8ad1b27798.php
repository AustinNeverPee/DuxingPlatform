...
<html lang="zh-cn">
  ...
  <body>
    ...
    <div class="container holder">
      <div class="jumbotron">
        <div class="row">
          ...
          筛选框（筛选方法暂时未定，暂时不必实现，先预留位置）
          </div><!-- /左侧筛选框 -->

          <!-- 右侧-->
          <div class="showAlbum well col-md-10">
            <div class="albumContainer row">
              <div class="albumItem well col-md-12">
                <!-- 相册信息 相册名&创建时间 -->
                <div class="albumInfo well row">
                  <h2 class="albumTitle col-md-offset-5 col-md-2">相册名</h2>
                  <span class="albumTime pull-right">创建时间</span>
                </div>
                ...
                <div id="carousel-album" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="item active">
                      <img src="/welfare/Common/Static/resources/slide1.jpg" alt="...">
                    </div>
                    <div class="item">
                      <img src="/welfare/Common/Static/resources/slide2.jpg" alt="...">
                    </div>
                    <div class="item">
                      <img src="/welfare/Common/Static/resources/slide3.jpg" alt="...">
                    </div>
                  </div>
    ...
    <script src="/welfare/Common/Static/js/my_album.js" type="text/javascript"></script>
  </body>
</html>