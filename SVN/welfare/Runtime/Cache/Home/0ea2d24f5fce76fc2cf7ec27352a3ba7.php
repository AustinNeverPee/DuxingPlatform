...
<html lang="zh-cn">
  ...
  <body>
      ...
      <div class="jumbotron">
        <div class="row">
          ...
          <div class="showActivity well col-md-10">
            <div class="activityContainer row">
              <div class="activityItem col-md-3">
                <a href="" class="thumbnail">
                  <img src="resources/1.jpg" alt="通用的占位符缩略图">
    ...
    <script src="/welfare/Common/Static/js/my_activity.js" type="text/javascript"></script>
  </body>
</html>