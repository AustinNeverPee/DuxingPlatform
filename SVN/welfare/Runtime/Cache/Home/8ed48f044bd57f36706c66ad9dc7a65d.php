...
<html lang="zh-cn">
  <head>
    ...
    <link href="<?php echo ($static); ?>/css/location.css" rel="stylesheet" type="text/css" media="screen">
  ...
  <body>
    ...
    <script src="<?php echo ($static); ?>/js/location.js" type="text/javascript"></script>
  </body>
</html>