...
<html lang="zh-cn">
  ...
  <body>
      ...
      <div class="container-fluid">
        <div class="navbar-collapse collapse dropdown col-md-10">
          <ul class="nav nav-tabs" role="tablist">
            <li><a href="<?php echo ($gate); ?>/HomePage">首页</a></li>
        ...
        <div class="info pull-right col-md-3 hidden">
         	...
         	<div class="headImage pull-left">
         		<a href="#">
         			<img src="<?php echo ($static); ?>/resources/head.jpg">
         		</a>
         	</div>
    ...
    <div class="container holder">
      <!-- 地图 功能未实现 -->
      <img src="<?php echo ($static); ?>/resources/map.jpg" width="60%" style="margin-left: 200px" />
    </div><!-- /页面主要内容 -->
