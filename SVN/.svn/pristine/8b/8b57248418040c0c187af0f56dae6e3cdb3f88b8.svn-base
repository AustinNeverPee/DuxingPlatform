...
<html lang="zh-cn">
  <head>
    ...
    <link href="<?php echo ($static); ?>/css/location_album.css" rel="stylesheet" type="text/css" media="screen">
  ...
  <body>
    ...
    <script src="<?php echo ($static); ?>/js/location_album.js" type="text/javascript"></script>
  </body>
</html>