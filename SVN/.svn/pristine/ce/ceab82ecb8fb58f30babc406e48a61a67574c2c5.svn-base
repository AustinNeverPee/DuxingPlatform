...
<html lang="zh-cn">
  <head>
    ...
    <link href="/welfare/Common/Static/css/location_newplace.css" rel="stylesheet" type="text/css" media="screen">
  ...
  <body>
    ...
    <div class="btn-group-vertical levelTwo">
      <a href="location.html" class="btn btn-info" role="button">
        地点索引
      </a>
      <a href="location_newplace.html" class="btn btn-info" role="button">
        新建地点
      </a>
    </div><!-- /二级菜单按钮-->
    ...
    <script src="/welfare/Common/Static/js/location_newplace.js" type="text/javascript"></script>
  </body>
</html>