...
<html lang="zh-cn">
  <head>
    ...
    <link href="/welfare/Common/Static/css/location_school.css" rel="stylesheet" type="text/css" media="screen">
  ...
  <body>
          ...
          <!--学校简介-->
                ...
                <div class="col-md-4">
                  <div class="poster">
                    <a href="http://www.baidu.com">
                      <img src="/welfare/Common/Static/resources/0.jpg" title="faegaer" class="img-poster">
                     </a>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="poster">
                    <img src="" title="" class="img-poster">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="poster">
            ...
            <div class="well row" id="communicateBox">
              ...
              <form role="form">
                ...
                <button type="submit" class="btn btn-primary" id="subcomment">提交</button>
              </form>
    ...
    <script src="/welfare/Common/Static/js/location_school.js" type="text/javascript"></script>
  </body>
</html>